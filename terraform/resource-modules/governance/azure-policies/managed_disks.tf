...
resource "azurerm_policy_assignment" "pol_managed_disks_assignment" {
  ...
  scope                = var.scope
  policy_definition_id = "/subscriptions/${data.azurerm_subscription.current.subscription_id}/providers/Microsoft.Authorization/policyDefinitions/06a78e20-9358-41c9-923c-fb736d382a4d"
