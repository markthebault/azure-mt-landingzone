...
| aks\_subnet\_id | The subnet identifier AKS should join to | `string` | n/a | yes |
| kubernetes\_client\_id | The Client ID for the Service Principal to use for this Managed Kubernetes Cluster | `string` | n/a | yes |
| kubernetes\_client\_secret | The Client Secret for the Service Principal to use for this Managed Kubernetes Cluster | `string` | n/a | yes |
...
| aks\_default\_nodepool\_node\_count | The number of nodes in default node pool for AKS | `number` | n/a | yes |
| aks\_default\_nodepool\_nodes\_max | The max number of nodes in default node pool for AKS | `number` | `30` | no |
| aks\_default\_nodepool\_node\_size | Node size in default node pool for AKS | `string` | n/a | yes |
...
| kubernetes\_rbac\_aad\_enabled | Is AKS Role Based Access Control integration with AAD Enabled? | `bool` | `false` | no |
